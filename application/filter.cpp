...
/*
 * get the reflection of model
 *
 *Model->getpolydata->filter(copy model)->mapper->actor->render->renderwindow
 *  |                                                      ^
 *  v                                                      |
 * getActor------------------------------------------------|
 *
...
/*
 * show the curvature of model
 *
 *
 * pipeline:Model->getpolydata->filter->mapper->actor->render->renderwindow
 *                                |               ^
 *                                ->scalarbar-----|
 */
